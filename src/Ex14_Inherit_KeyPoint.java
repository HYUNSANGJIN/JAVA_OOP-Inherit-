...
class Buyer3 { // 구매자
    ...
    void Summary() {
        ...
        String productlist = "";
        /*
         * for(int i = 0 ; i < Cart.length ; i++) { //다행이도 10개 다사면 ... if(Cart[i] ==
         * null) break; //방어적인 코드 ... totalprice += Cart[i].price; totalbonuspoint +=
         * Cart[i].bonuspoint; productlist += Cart[i].toString() + " "; }
         */
...
public class Ex14_Inherit_KeyPoint {
